...
def main1():
    ...
    while run:
        clock.tick(fps)
        fckn_var = str(emg1.ser.read(emg1.ser.in_waiting))
        print(fckn_var)
        if finish == 0:
            if players == 2:
        ...
        if finish == 1:
            ...
            chicken_red = 0
            chicken_blue = 0
        if '1run' in fckn_var and pl1 == True:
            start_music.jump_hero.play(start_music.jump)
            click_red_chicken = 'up'
            pl1 = False
        elif '1run' in fckn_var and pl1 == False:
            start_music.jump_hero.play(start_music.jump)
            click_red_chicken = 'down'
            pl1 = True
        if '2run' in fckn_var and pl2 == True:
            start_music.jump_hero.play(start_music.jump)
            click_blue_chicken = 'up'
            pl2 = False
        elif '2run' in fckn_var and pl2 == False:
            start_music.jump_hero.play(start_music.jump)
            click_blue_chicken = 'down'
            pl2 = True
